...
struct SimplePaymentForm_Previews: PreviewProvider {
    static var previews: some View {
        SimplePaymentForm(viewModel:  SimplePaymentFormViewModel(engine: PaylikeEngine(merchantID: "YOUR_CODE", engineMode: .TEST, loggingMode: .DEBUG), amount: PaymentAmount(currency: CurrencyCodes.BHD, value: 300000, exponent: 2)))
    }
}
